    ...
    <Box
      sx={{
        ...
        '&::before': {
          ...
          bottom: 0,
          background:
            'radial-gradient(circle at 20% 50%, rgba(120, 119, 198, 0.3), transparent 50%), radial-gradient(circle at 80% 20%, rgba(255, 119, 198, 0.3), transparent 50%), radial-gradient(circle at 40% 80%, rgba(120, 119, 255, 0.3), transparent 50%)',
          pointerEvents: 'none',
        },
      }}
    >
      ...
      <Grid
        container
        spacing={3}
        sx={{ height: 'calc(100vh - 200px)', position: 'relative', zIndex: 1 }}
      >
        {/* Panel izquierdo */}
        <Grid
          item
        ...
        >
          <Grid
            ...
            sx={{ height: '100%' }}
          >
            {/* Usuarios en línea - ALTURA MEJORADA */}
            <Grid
              item
              xs={12}
              sx={{ height: '50%' }}
                ...
                >
                  ...
                  <Box
                    sx={{
                      ...
                      maxHeight: '300px', // Altura máxima para forzar el scroll
                      pr: 1,
                      // Removemos height: '100%' para evitar conflicto con flexGrow
                      '&::-webkit-scrollbar': {
                        width: '8px',
                      },
                    ...
                    {filteredOnlineUsers.length > 0 ? (
                      filteredOnlineUsers.map((user, index) => (
                        ...
                        >
                          <Card
                            sx={{
                              mb: 1.5, // Reducido para que quepan más
                            ...
                            onClick={() =>
                              startConversation(user.userId || user.id)
                            }
                          >
                            <CardContent
                              sx={{
            ...
            {/* Conversaciones activas - ALTURA MEJORADA */}
            <Grid
              item
              xs={12}
              sx={{ height: '50%' }}
                    ...
                    {conversations.length > 0 ? (
                      ...
                      >
                        <CardContent sx={{ textAlign: 'center', py: 3 }}>
                          ...
                          >
                            Haz click en un usuario para iniciar una
                            conversación
                          </Typography>
                        </CardContent>
                      </Card>
                              ...
                              sx={{
                                ...
                                '&::before': !isOwnMessage
                                  ? {
                                      ...
                                      borderRight:
                                        '10px solid rgba(255,255,255,0.9)',
                                      borderBottom:
                                        '10px solid rgba(255,255,255,0.9)',
                                    }
                                  : {},
